...
const FSHADER_SOURCE =
  ...
  'vec3 tnorm = normalize(u_NormalMat * norm);\n' +
  'vec4 eyeCoords = u_ModelView * vec4(position, 1.0);\n' +
  'vec3 s = normalize(vec3(u_ModelView * LightPosition-eyeCoords));\n' +
  ...
  'vec3 Light = phongModel(Position, Norm);\n' +
...
function main() {
	...
	gl.uniform4f(LightPosition, -0.7, 1, 1, 0);
